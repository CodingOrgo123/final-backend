    ...
    const mailOptions = {
        ...
        html: `
            ...
            <div style="text-align: center;">
                <a href="/verify?token=${token}&email=${email}" style="padding: 10px 20px; background-color: #007bff; color: #ffffff; text-decoration: none; border-radius: 5px; display: inline-block;">Verify Email</a>
            </div>
